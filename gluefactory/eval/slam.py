...
class SlamPipeline(EvalPipeline):
    default_conf = {
        "data": {
    ...
    def get_dataloader(self, data_conf=None):
        ...
        data_conf = data_conf if data_conf is not None else self.conf.data
    ...
    def run_eval(self, loader, pred_file):
        ...
        for i, data in enumerate(tqdm(loader)):
            ...
            # evaluate matches and relative poses
...
if __name__ == "__main__":
    ...
    default_conf = OmegaConf.create(SlamPipeline.default_conf)
