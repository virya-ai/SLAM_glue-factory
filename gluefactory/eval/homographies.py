...
class HomographiesPipeline(EvalPipeline):
    default_conf = {
        "data": {
            "batch_size": 1,
            "name": "homographies",
    ...
    def get_dataloader(self, data_conf=None):
        ...
        dataset = get_dataset("homographies")(data_conf)
    ...
    def run_eval(self, loader, pred_file):
        ...
        for i, data in enumerate(tqdm(loader)):
            ...
            results_i["names"] = data["name"][0] if isinstance(data["name"], list) else data["name"]
            results_i["scenes"] = "custom"
...
if __name__ == "__main__":
    ...
    default_conf = OmegaConf.create(HomographiesPipeline.default_conf)
    ...
    pipeline = HomographiesPipeline(conf)
    s, f, r = pipeline.run(
