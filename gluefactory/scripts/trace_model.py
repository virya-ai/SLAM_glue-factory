...
def export_superglue_onnx(
    ...
    with torch.no_grad():
        torch.onnx.export(
            ...
            dynamic_axes={
                "keypoints0":       {0: "batch", 1: "num_kpts0"},
                "keypoints1":       {0: "batch", 1: "num_kpts1"},
                "descriptors0":     {0: "batch", 2: "num_kpts0"},
                "descriptors1":     {0: "batch", 2: "num_kpts1"},
                "scores0":          {0: "batch", 1: "num_kpts0"},
                "scores1":          {0: "batch", 1: "num_kpts1"},
                "size0":            {0: "batch"},
                "size1":            {0: "batch"},
                "matches0":         {0: "batch", 1: "num_kpts0"},
                "matches1":         {0: "batch", 1: "num_kpts1"},
                "matching_scores0": {0: "batch", 1: "num_kpts0"},
                "matching_scores1": {0: "batch", 1: "num_kpts1"},
            },
            opset_version=opset,
        )
    print(f"[SG] saved  → {out_path}")
